...
import unittest
from .test_rules import UTC_01, UTC_02, EAST_01, EAST_02, CENT_01, CENT_02
...
class TestTimezone(unittest.TestCase):
    ...
    def test_tz_eq(self):
        ...
        # Given
        tz1 = Timezone(EST, EDT, "MyZone")
        tz2 = Timezone(EST, EDT, "MyZone")
